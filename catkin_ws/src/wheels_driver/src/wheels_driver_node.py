...
class WheelsDriverNode(object):
    def __init__(self):
        ...
        self.sub_rad_lim = rospy.Subscriber(
            "~radius_limit", BoolStamped, self.cbRadLimit, queue_size=1)

        self.params_update = rospy.Timer(
            rospy.Duration.from_sec(1.0), self.updateParams)
